...
def main():
    ...
    for node in all_func_node:
        ...
        for v in opted_pdg_5.vs():
            ...
            f.write(str(v['name']) + ' : ' + str(v['code']) + str(v['type']) + str(v['location']) + '\n')
        for e in opted_pdg_5.es():
            print opted_pdg_5.vs[e.tuple[0]]['name'],' -----> ',opted_pdg_5.vs[e.tuple[1]]['name'],e['var']
            f.write(str(opted_pdg_5.vs[e.tuple[0]]['name']) + ' -----> ' + str(opted_pdg_5.vs[e.tuple[1]]['name']) + str(e['var']) + '\n')
        
        # f = open('init_pdg.txt', 'a+')
        # f.write("----------------------------init pdg--------------------------------------------------\n")
        ...
        #     f.write(str(opt_pdg_1.vs[e.tuple[0]]['name']) + ' -----> ' + str(opt_pdg_1.vs[e.tuple[1]]['name']) + str(e['var']) + '\n')
